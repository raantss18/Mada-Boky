...
première, la dernière mise à part, qui rappelle le principe de récurrence du
chapitre 8.
...
\begin{corrige}
\textbf{1.} $A+B = \matdeux{3}{0}{-2}{4}$ et
$3A = \matdeux{6}{-3}{0}{12}$.

\textbf{2.} $AB = \matdeux{4}{2}{-8}{0}$ et $BA = \matdeux{2}{3}{-4}{2}$ :
le produit matriciel n'est pas commutatif.

\textbf{3.} $N^{2} = \mattrois{0}{0}{1}{0}{0}{0}{0}{0}{0}$ et
$N^{3}$ est la matrice nulle. Une matrice non nulle peut donc avoir une
puissance nulle — ce qui n'arrive jamais avec les nombres.

\textbf{4.} $AB = \matdeux{1}{3}{0}{1} = BA$ : ces deux-là commutent, parce
qu'elles s'écrivent toutes deux $I_{2}+\lambda N$ avec la même matrice
$N = \matdeux{0}{1}{0}{0}$.

\textbf{5.} Posons $M = \matdeux{a}{b}{c}{d}$ et $J = \matdeux{1}{1}{0}{1}$.
Alors $MJ = \matdeux{a}{a+b}{c}{c+d}$ et $JM = \matdeux{a+c}{b+d}{c}{d}$.
L'égalité impose $c = 0$ puis $a = d$ : les matrices cherchées sont exactement
les $\matdeux{a}{b}{0}{a}$, c'est-à-dire les $aI_{2}+bN$.
\end{corrige}
...
\begin{corrige}
\textbf{6.} $\dete\matdeux{5}{2}{3}{4} = 20-6 = 14$ et
$\dete\matdeux{6}{-2}{-3}{1} = 6-6 = 0$ : la seconde matrice n'est pas
inversible.

\textbf{7.} La première est triangulaire supérieure : son déterminant est le
produit des coefficients diagonaux, soit $1$. Pour la seconde, on développe
suivant la dernière ligne :
$\dete = -1 \times \dete\matdeux{2}{3}{1}{0} = -1\times(-3) = 3$.

\textbf{8.} $\dete\matdeux{m}{1}{4}{m} = m^{2}-4$, qui s'annule pour
$m = 2$ et $m = -2$.

\textbf{9.} Multiplier une matrice par $2$ revient à multiplier chacune de ses
trois lignes par $2$. Or multiplier une ligne par un scalaire multiplie le
déterminant par ce scalaire : le déterminant est donc multiplié par
$2\times2\times2 = 8$.
\end{corrige}
...
\begin{corrige}
\textbf{10.} Le déterminant vaut $3\times2-1\times5 = 1$, donc l'inverse est
$\matdeux{2}{-1}{-5}{3}$.

\textbf{11.} $A^{2} = \mattrois{1}{0}{4}{0}{1}{6}{0}{0}{1}$, d'où
$2A-A^{2} = I_{3}$. En factorisant, $A\left(2I_{3}-A\right) = I_{3}$ : la
matrice $A$ est inversible et
$A^{-1} = 2I_{3}-A = \mattrois{1}{0}{-2}{0}{1}{-3}{0}{0}{1}$.

\textbf{12.} De $A^{3} = I_{3}$ on tire $A \times A^{2} = I_{3}$ : la matrice
$A$ est inversible et $A^{-1} = A^{2}$.

\textbf{13.} L'égalité s'écrit
$A\left(4I_{3}+A-A^{2}\right) = 4I_{3}$, donc
$A \times \dfrac14\left(4I_{3}+A-A^{2}\right) = I_{3}$ et
$A^{-1} = \dfrac14\left(4I_{3}+A-A^{2}\right)$.
\end{corrige}
...
\begin{corrige}
\textbf{14.} $A^{2} = \matdeux{1}{2}{0}{1}$ et $A^{3} = \matdeux{1}{3}{0}{1}$ :
on conjecture $A^{n} = \matdeux{1}{n}{0}{1}$.

\textbf{15.} La formule est vraie au rang $1$. Si $A^{n} = \matdeux{1}{n}{0}{1}$,
alors
$A^{n+1} = A^{n}A = \matdeux{1}{n}{0}{1}\matdeux{1}{1}{0}{1}
= \matdeux{1}{n+1}{0}{1}$, ce qui est la formule au rang $n+1$.

\textbf{16.} Le produit de deux matrices diagonales se fait coefficient par
coefficient, donc
$B^{n} = \mattrois{2^{n}}{0}{0}{0}{3^{n}}{0}{0}{0}{6^{n}}$.

\textbf{17.} La formule est vraie au rang $1$. Si $A^{n} = PB^{n}P^{-1}$,
alors
\[
  A^{n+1} = A^{n}A = PB^{n}P^{-1}\,PBP^{-1} = PB^{n}\,I\,BP^{-1}
  = PB^{n+1}P^{-1},
\]
le produit $P^{-1}P$ disparaissant au passage. C'est là tout l'intérêt de la
diagonalisation : les puissances de $B$ se calculent d'un trait.
\end{corrige}
...
\begin{corrige}
\textbf{18.} Le système s'écrit $AX = B$, où
$A = \matdeux{2}{1}{1}{-1}$, où $X$ est la colonne des inconnues $x$ et $y$,
et où $B$ est la colonne des seconds membres $3$ et $0$. Le déterminant de
$A$ vaut $-3$, non nul : la solution est unique. La deuxième équation donne
$x = y$, et la première $3x = 3$ : on trouve $x = y = 1$.

\textbf{19.} Le déterminant de $\matdeux{1}{2}{3}{5}$ vaut $-1$, donc
l'inverse est $\matdeux{-5}{2}{3}{-1}$. En l'appliquant au second membre
$(1\,;4)$, on obtient $x = -5+8 = 3$ et $y = 3-4 = -1$. La vérification
donne bien $3-2 = 1$ et $9-5 = 4$.

\textbf{20.} Le déterminant du système vaut $m^{2}-1$. Si $m \neq 1$ et
$m \neq -1$, il est non nul : le système a une solution unique, et en
soustrayant les deux équations on trouve $x = y = \dfrac{1}{m+1}$. Si
$m = 1$, les deux équations se réduisent à $x+y = 1$ : il y a une infinité de
solutions. Si $m = -1$, elles deviennent $-x+y = 1$ et $x-y = 1$, qui sont
incompatibles : il n'y a aucune solution.
\end{corrige}
...
\exods{1}{Baccalauréat, Congo-Brazzaville, série C, session 2022 — exercice 1}{5 points}
...
\exods{2}{Baccalauréat, Congo-Brazzaville, série C, session 2022 — exercice 1, adapté}{7 points}
Les diviseurs positifs de $195$ ayant été déterminés, écrire $195$ en base
$5$, puis en base $2$, et vérifier les deux écritures.

\exods{3}{Baccalauréat, Madagascar, série S, session 2021 — exercice 1, partie I}{8 points}
On considère
\[
  A = \mattrois{0}{1}{2}{1}{3}{0}{1}{2}{1}, \qquad
  B = \frac13\mattrois{-3}{-3}{6}{1}{2}{-2}{1}{-1}{1}, \qquad
...
\textbf{Exercice 1.} $7(12+3t)+3(37-7t) = 84+21t+111-21t = 195$. Puisque $d$ divise $x$
...
\textbf{Exercice 2.} $195 = 5\times39+0$, $39 = 5\times7+4$, $7 = 5\times1+2$,
$1 = 5\times0+1$, d'où $195 = \overline{1\,240}^{\,5}$. En binaire,
$195 = 128+64+2+1 = \overline{1100\,0011}^{\,2}$. Les deux vérifications
redonnent bien $195$.

\textbf{Exercice 3.} Le produit $AB$ se calcule ligne par colonne et donne $I_{3}$ ; il
en va de même de $BA$ : $B$ est bien l'inverse de $A$. Ensuite
$A+C = \mattrois{2}{3}{2}{1}{5}{0}{1}{2}{3}$.
