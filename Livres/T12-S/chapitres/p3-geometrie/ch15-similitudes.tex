...
% Comparaison adaptée des figures de TCD/Similitude/Lesona.tex.
...
\begin{tikzpicture}[x=.92cm,y=.92cm,font=\footnotesize]
  \begin{scope}[xshift=-3.7cm]
    ...
    \draw[bmtAccent,line width=1.15pt]
      (1.75,.15)--(3.65,.55)--(2.25,1.65)--cycle;
    \node[bmtAccent,below] at (1.75,.15) {$A'$};
    \node[bmtAccent,right] at (3.65,.55) {$B'$};
    \node[bmtAccent,above] at (2.25,1.65) {$C'$};
  ...
  \begin{scope}[xshift=2.1cm]
    ...
    \node[bmtGris,above] at (.35,1) {$C$};
    \draw[bmtAccent,line width=1.15pt]
      (3.55,0)--(2.1,.2)--(3.25,1.35)--cycle;
    \node[bmtAccent,below right] at (3.55,0) {$A'$};
    \node[bmtAccent,below] at (2.1,.2) {$B'$};
    \node[bmtAccent,above] at (3.25,1.35) {$C'$};
