...
\begin{visualisation}[un polygone régulier inscrit]
\begin{center}
\begin{tikzpicture}[x=1cm, y=1cm, font=\footnotesize]
  \draw[bmtVetiver, line width=1.1pt] (0,0) circle (2.2);
  \filldraw[bmtEncre] (0,0) circle (1.6pt) node[anchor=north east] {$O$};
  \draw[bmtLaterite, line width=0.9pt] (0,0) -- (20:2.2);
  \node[bmtLaterite, anchor=north west] at (10:1.1) {$R^{1/n}$};
  \foreach \ang/\lab in {20/z_{0},80/z_{1},140/z_{2},200/z_{3},260/z_{4},320/z_{5}} {
    \filldraw[bmtIndigo] (\ang:2.2) circle (2pt);
    \node[bmtIndigo] at (\ang:2.55) {$\lab$};
  }
  \draw[bmtIndigo, line width=0.8pt]
    (20:2.2) -- (80:2.2) -- (140:2.2) -- (200:2.2) -- (260:2.2) -- (320:2.2) -- cycle;
  \draw[bmtVetiver, line width=0.8pt] (20:0.85) arc (20:80:0.85);
  \node[bmtVetiver, anchor=south west] at (48:0.98) {$\frac{2\pi}{n}$};
\end{tikzpicture}
\end{center}
Les $n$ solutions de $z^{n}=Z$ sont régulièrement réparties sur le cercle de
centre $O$ et de rayon $R^{1/n}$ : d'une racine à la suivante, l'argument
augmente exactement de $\frac{2\pi}{n}$. Ici $n=6$ ; le même dessin vaut pour
n'importe quel entier $n \geq 2$, avec un polygone à $n$ côtés.
\end{visualisation}
