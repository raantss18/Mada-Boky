% ===========================================================================
%  Chapitre 17 — Annuités et emprunts indivis
%  PE 2026, composante TRAITEMENT DES DONNÉES — série OSE
% ===========================================================================
\bmtchapitre{Annuités et emprunts indivis}
  {Calculer la valeur acquise et la valeur actuelle d'une suite d'annuités
   constantes, établir un tableau d'amortissement d'un emprunt indivis, et
   comparer les modes de remboursement par annuités constantes et par
...
intervalles réguliers. Ce chapitre clôt les mathématiques financières en
répondant à la question la plus concrète du programme : combien épargne-t-on
au bout de $n$ ans de versements réguliers, et combien emprunte-t-on quand on
promet de rembourser une somme fixe chaque année ?
...
se termine le chapitre, et le programme de terminale.

% ---------------------------------------------------------------------------
\begin{revision}
Chapitre précédent et suites géométriques.
...
Ce dernier chapitre récompense les élèves qui maîtrisent déjà les suites
