...
% ===========================================================================
\begin{jecherche}[le rond-point du marché de Toamasina]
La municipalité aménage un rond-point commercial : six échoppes doivent être
réparties aux sommets d'un hexagone régulier, sur un cercle de rayon
$6$ mètres centré sur le rond-point, afin que chaque commerçant dispose
exactement de la même distance à parcourir jusqu'au centre de collecte des
déchets, situé au centre du cercle. Le plan est rapporté à un repère
orthonormé direct d'origine ce centre, l'unité valant un mètre. La première
échoppe est placée au point d'affixe $6$.

\begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=*, itemsep=0.3em]
  \item Justifier que les affixes des six échoppes sont les solutions de
        l'équation $z^{6} = 6^{6}$.
  \item Déterminer ces six affixes sous forme exponentielle, puis sous forme
        algébrique.
  \item Calculer la distance entre deux échoppes voisines : c'est la largeur
        de l'allée piétonne à prévoir entre elles.
  \item Le service technique veut installer une septième échoppe, réservée
        aux produits frais, exactement au centre du rond-point. Justifier
        que la somme des affixes des six premières échoppes est nulle, et
        interpréter ce résultat pour le positionnement de la septième.
  \item Une réorganisation du marché fait tourner l'ensemble du dispositif
        d'un angle de $\frac{\pi}{6}$ autour du centre. Quelle est la
        nouvelle affixe de la première échoppe ?
  \item Un unique câble électrique relie chaque échoppe au centre de
        distribution. Quelle longueur totale de câble la commune doit-elle
        budgétiser ?
\end{enumerate}
\end{jecherche}

\begin{corrige}[le rond-point du marché de Toamasina]
...
régulier, le côté est égal au rayon. Les échoppes voisines sont donc
espacées de six mètres, ce qui donne la largeur d'allée à prévoir.
...
gravité des six échoppes est le centre du rond-point : la septième échoppe,
placée au centre, est donc à équidistance pondérée de toutes les autres.

\textbf{5.} Une rotation d'angle $\frac{\pi}{6}$ multiplie l'affixe par
$e^{i\pi/6}$ : la première échoppe passe en $6e^{i\pi/6}
= 3\sqrt3+3i$.
