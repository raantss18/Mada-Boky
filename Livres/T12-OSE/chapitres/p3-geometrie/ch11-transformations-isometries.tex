% ===========================================================================
%  Chapitre 11 — Transformations du plan et isométries
...
\textbf{2. a)} $\vect{AC} = \vect{AD}+\vect{DC}$, donc
...
\textbf{3. a)} La somme des angles vaut $\frac{\pi}{2}+\frac{\pi}{2} = \pi$ :
...
\textbf{4.} La somme des angles vaut $\frac{\pi}{3}-\frac{\pi}{3} = 0$ : $g$
...
\textbf{5. a)} $f$ et $g$ sont des déplacements d'angle $\frac{\pi}{2}$ : ce
...
\textbf{6. a)} $BC = CD$ car $D$ est le symétrique de $O$ par rapport à
...
\textbf{7. a)} $g$ est composée d'une réflexion et d'une translation :
...
Un tisserand compose un motif sur une bande de lamba destinée à la vente sur
le marché. Le motif de base est un triangle $T$, et la bande est obtenue en
répétant deux opérations : la réflexion $s$ d'axe la droite médiane
horizontale de la bande, et la translation $t$ de vecteur horizontal $\vecu$
de longueur $6$~cm.
...
\begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=*, itemsep=0.3em]
  ...
  \item Le tisserand veut que le motif se reproduise à l'identique tous les
        $12$~cm, afin de calibrer la longueur de tissu nécessaire par bande.
        Est-ce compatible avec la question précédente ?
  \item Quelle est la nature de $s \circ t$ ? Cette transformation est-elle
        égale à $t \circ s$ ?
  \item On ajoute une seconde réflexion $s'$, d'axe vertical, pour créer un
        motif de bordure. Déterminer la nature de $s' \circ s$.
  \item Le tisserand souhaite obtenir une rotation d'un quart de tour pour un
        motif circulaire. Quels axes doit-il choisir ?
\end{enumerate}
\end{jecherche}
...
retrouvant dans son orientation d'origine — le tisserand peut donc calibrer
sa bande par multiples de douze centimètres.
