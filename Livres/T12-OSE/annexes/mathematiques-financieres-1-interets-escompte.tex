% ===========================================================================
%  Annexe — Mathématiques financières, I. Intérêts et escompte
%  Hors des quatre composantes chiffrées du PE 2026 ; RAPE, période 4 ;
%  exercice 3 de chaque sujet de baccalauréat OSE examiné.
% ===========================================================================
\chapter{Intérêts et escompte}
\markboth{Mathématiques financières}{Intérêts et escompte}

Premier volet de cette annexe consacrée aux mathématiques financières :
...
Cette annexe traite deux grandes familles de calcul. L'\textbf{intérêt
...
taux annoncé $t$ — un point détaillé dans l'exercice-recherche de cette
annexe.
\end{avertissement}
...
premières parties relèvent de ce volet, la troisième étant traitée au volet
suivant de cette annexe — est repris d'un sujet réellement posé.
...
La difficulté de cette annexe n'est jamais le calcul lui-même, mais le choix
de la bonne formule et de la bonne unité de durée. Imposez une phrase de
