...
\textbf{Série} & Littéraire, options A1 et A2\\
\textbf{Code matière} & $009$\\
\textbf{Durée} & $2$ heures $15$ minutes\\
\textbf{Coefficients} & A1 : $1$ \quad\textbullet\quad A2 : $3$\\
...
\noindent Le barème est stable d'une session à l'autre :
...
\hline
Exercice 1 & $5$ & Suites numériques — à chacune des sessions dépouillées
pour ce livre, de $1999$ à $2026$\\
Exercice 2 & $5$ & Probabilité, ou statistique à deux variables, en
alternance\\
Problème & $10$ & Étude d'une fonction contenant un logarithme ou une
exponentielle ; les dernières questions, réservées à l'option A2, portent
sur une primitive et une aire\\
\hline
\end{tabular}
\end{center}

Les deux options composent sur le \emph{même} sujet. L'option A2 traite une
ou deux questions supplémentaires et dispose d'un barème propre, plus
resserré sur les questions mécaniques. Un candidat de A1 qui traite les
questions A2 n'y gagne aucun point : mieux vaut relire les autres.

\section{Un sujet complet à traiter en 2 h 15}

\begin{devoirsurveille}[Baccalauréat, Madagascar, série A, session 2026]
Les deux exercices et le problème sont obligatoires. Calculatrice
scientifique non programmable autorisée. Barème \textup{(A1 ; A2)}.
...
\[
  \begin{cases} U_{0} = 5\\[0.2em] U_{n+1} = \dfrac{U_{n}+3}{4}\end{cases}
\]

\begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=*, itemsep=0.25em]
  \item Calculer $U_{1}$, $U_{2}$. \bareme{0,5 ; 0,5}
  \item On pose la suite $\left(V_{n}\right)_{n \in \N}$ telle que
        $V_{n} = U_{n}-1$.
    \begin{enumerate}[label=\textbf{\alph*)}, leftmargin=1.4em, itemsep=0.15em]
      \item Montrer que $\left(V_{n}\right)$ est une suite géométrique dont
            on précisera la raison et le premier terme $V_{0}$.
            \bareme{1 ; 1}
      \item Exprimer $V_{n}$ en fonction de $n$. \bareme{1 ; 1}
  ...
  \item Soit $S_{n} = V_{0}+V_{1}+\cdots+V_{n}$ et
    ...
    \begin{enumerate}[label=\textbf{\alph*)}, leftmargin=1.4em, itemsep=0.15em]
      \item Exprimer $S_{n}$ en fonction de $n$. \bareme{1 ; 1}
...
\begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=*, itemsep=0.25em]
  \item Construire le nuage des points associé à cette série statistique
        ...
        puis $1$ cm pour $10$ élèves. \bareme{1 ; 1}
...
\begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=*, itemsep=0.25em]
  ...
  \item \begin{enumerate}[label=\textbf{\alph*)}, leftmargin=1.4em, itemsep=0.15em]
      \item Pour tout $x \in \intervalleo{0}{+\infty}$, calculer $f'(x)$ où
            $f'$ est la fonction dérivée de $f$. \bareme{2 ; 1,5}
      \item Montrer que $f'(x) = \dfrac{-2x^{2}+x+1}{x^{2}}$,
            $\forall\, x>0$. \bareme{1 ; 0,75}
      \item En déduire le signe de $f'(x)$, pour tout
            $x \in \intervalleo{0}{+\infty}$. \bareme{1 ; 0,5}
    \end{enumerate}
  \item Dresser le tableau de variation de $f$. \bareme{2 ; 1,5}
  \item Écrire une équation de la tangente $(T)$ à $(\mathcal C)$ au point
        d'abscisse $x_{0} = 1$. \bareme{1 ; 0,75}
  \item Tracer $(\mathcal C)$ et $(T)$ sur l'intervalle
        $\intervalleof{0}{4}$. \bareme{2 ; 1,5}
\end{enumerate}
...
Le corrigé complet de ce sujet est réparti dans le livre, à sa place
naturelle : l'exercice 1 au chapitre 11, l'exercice 2 au chapitre 14, le
problème au chapitre 7 et sa question A2 au chapitre 9. C'est voulu : un
élève qui cherche la correction d'une question trouve, du même coup, le
cours dont elle relève.
...
Primitives, aires (A2) & 9 & $1999$, $2003$, $2005$, $2013$, $2015$,
$2016$, $2017$, $2020$, $2021$, $2026$\\
Suites, généralités & 10 & $2010$, $2013$, $2014$, $2017$, $2020$, $2026$\\
Suites arithmétiques et géométriques & 11 & $2013$, $2014$, $2015$, $2016$,
$2017$, $2020$, $2021$, $2022$, $2026$\\
Dénombrement & 12 & $2000$, $2001$, $2004$, $2009$, $2015$, $2020$,
$2022$\\
Probabilité & 13 & $2004$, $2012$, $2015$, $2016$, $2020$, $2021$,
$2022$\\
Statistique à deux variables & 14 & $2000$, $2002$, $2010$, $2014$,
$2017$, $2026$\\
\hline
\end{tabular}
\end{center}
...
Exercice 1 & $30$ min & Les suites : la question la plus mécanique du
sujet, et cinq points\\
Exercice 2 & $30$ min & Probabilité ou statistique. Si c'est la
statistique, commencer par le tracé — il sèche pendant que vous calculez\\
