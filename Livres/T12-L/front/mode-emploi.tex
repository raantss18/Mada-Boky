...
\begin{remarque}[les questions réservées à l'option A2]
Les options A1 et A2 composent sur le même sujet, mais A2 traite en plus une
ou deux questions — le plus souvent une primitive et un calcul d'aire — et
avec un coefficient trois fois plus élevé. Ces questions sont signalées
partout dans le livre par la mention ci-dessous, et jamais reléguées en fin
de chapitre : elles restent à leur place logique dans le raisonnement.
\end{remarque}

\pourAdeux
Calculer, en $\text{cm}^{2}$, l'aire du domaine plan délimité par la courbe,
