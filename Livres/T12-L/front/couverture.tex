...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=north west, text=bmtPapier, align=left, text width=13.6cm,
    ...
    {Algèbre \quad Analyse \quad Traitement des données et probabilités};
  ...
  % Les trois couleurs des trois parties, en signature de bas de page
  \foreach \c [count=\i from 0] in {bmtLaterite, bmtIndigo, bmtRaphia}{
