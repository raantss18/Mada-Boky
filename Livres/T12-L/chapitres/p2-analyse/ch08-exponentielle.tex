...
primitive et d'aire, réservées à l'option A2, sont traitées au chapitre 9.
...
La population d'une commune du Vakinankaratra, en milliers d'habitants,
est modélisée par
\[
  P(t) = 12\,e^{0{,}021\,t},
\]
...
\begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=*, itemsep=0.25em]
  \item \begin{enumerate}[label=\textbf{\alph*)}, leftmargin=1.4em, itemsep=0.15em]
      \item Déterminer l'ensemble de définition de $f$. \bareme{0,75 ; 0,50}
      \item Calculer $\limminf f(x)$. \bareme{0,75 ; 0,50}
    ...
    \end{enumerate}
  \item \begin{enumerate}[label=\textbf{\alph*)}, leftmargin=1.4em, itemsep=0.15em]
      \item Calculer $f'(x)$. \bareme{1 ; 0,75}
      \item En déduire le tableau de variation de $f$. \bareme{1,25 ; 1}
    \end{enumerate}
  \item \begin{enumerate}[label=\textbf{\alph*)}, leftmargin=1.4em, itemsep=0.15em]
      \item Déterminer les coordonnées du point $A$, intersection de la
            courbe $(C)$ avec l'axe des ordonnées. \bareme{1 ; 0,75}
  ...
  \item \begin{enumerate}[label=\textbf{\alph*)}, leftmargin=1.4em, itemsep=0.15em]
      ...
      \item Étudier la branche infinie de $(C)$ lorsque $x$ tend vers
            $+\infty$. \bareme{1 ; 0,75}
    \end{enumerate}
  \item Tracer $(C)$. \bareme{1,5 ; 1,25}
\end{enumerate}

\begin{remarque}
La question 6 de ce sujet, réservée à l'option A2 — primitive de $f$ puis
aire du domaine limité par $(C)$, l'axe des abscisses et les droites
$x = 0$ et $x = \ln2$ —, figure au chapitre 9.
\end{remarque}
\end{commeaubac}
