...
A2 \textbullet\ 10 points, format du problème}
...
\begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=*, itemsep=0.25em]
  \item Justifier que $\Df = \R\setminus\{-1\}$. \bareme{0,5 ; 0,5}
  \item Vérifier que, pour tout $x \neq -1$,
        $f(x) = x+1+\dfrac{1}{x+1}$. \bareme{1,5 ; 1}
  \item En déduire :
