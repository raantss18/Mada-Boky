...
C'est aussi le chapitre le plus court du livre, et pourtant loin d'être
secondaire : les questions de primitive et d'aire valent, à chaque session,
deux à deux points et demi — un quart de la note du problème. Les comprendre
éclaire tout ce qui précède.
...
% ===========================================================================
\begin{annales}
Toutes les questions ci-dessous sont les dernières questions du problème des
sujets de baccalauréat : elles portent, session après session, sur la même
structure — vérifier une primitive, puis calculer une aire. Elles se
...
\begin{corrige}[comme au baccalauréat — Madagascar A 2003, question 6]
...
Deux heures seulement, et pourtant deux points et demi de l'épreuve. Le
rendement est donc le plus élevé du livre — à condition de ne pas chercher à
enseigner le calcul de primitives pour lui-même. Ici, on ne cherche jamais
une primitive : \textbf{le sujet la donne} et demande de la vérifier. C'est
un exercice de dérivation, et il faut le présenter comme tel.
