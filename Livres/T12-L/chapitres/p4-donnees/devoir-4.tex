...
probabilités seront donnés sous forme de fraction irréductible. Barème
\textup{(A1 ; A2)}.
...
\begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=*, itemsep=0.25em]
  \item On tire au hasard et simultanément $3$ jetons de la boîte.
    \begin{enumerate}[label=\textbf{\alph*)}, leftmargin=1.4em, itemsep=0.15em]
      \item Déterminer le nombre de cas possibles. \bareme{0,5 ; 0,5}
      \item Calculer la probabilité de l'événement
            $A$ : « obtenir trois jetons de même couleur ». \bareme{1 ; 1}
      \item Calculer la probabilité de l'événement
            $B$ : « obtenir exactement deux jetons verts ». \bareme{1 ; 1}
      \item Calculer la probabilité de l'événement
            $C$ : « obtenir au moins un jeton rouge ». \bareme{1 ; 1}
    \end{enumerate}
  ...
  \item On pose $V_{n} = U_{n}-6$ pour tout entier naturel $n$.
    \begin{enumerate}[label=\textbf{\alph*)}, leftmargin=1.4em, itemsep=0.15em]
      ...
      \item Exprimer $V_{n}$ puis $U_{n}$ en fonction de $n$.
            \bareme{1 ; 1}
      \item Calculer $\limn U_{n}$. \bareme{0,5 ; 0,5}
    \end{enumerate}
  \item Soit $S_{n} = V_{0}+V_{1}+\cdots+V_{n}$.
    \begin{enumerate}[label=\textbf{\alph*)}, leftmargin=1.4em, itemsep=0.15em]
      \item Exprimer $S_{n}$ en fonction de $n$. \bareme{1 ; 1}
      \item En déduire $T_{n} = U_{0}+U_{1}+\cdots+U_{n}$. \bareme{0,5 ; 0,5}
    \end{enumerate}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=*, itemsep=0.25em]
  \item \begin{enumerate}[label=\textbf{\alph*)}, leftmargin=1.4em, itemsep=0.15em]
      \item Calculer $\displaystyle\lim_{x \to 0^{+}} f(x)$ et en déduire
            une asymptote à $(\mathcal C)$. \bareme{1 ; 0,75}
      \item Calculer $\limpinf f(x)$. \bareme{1 ; 0,75}
    \end{enumerate}
  \item \begin{enumerate}[label=\textbf{\alph*)}, leftmargin=1.4em, itemsep=0.15em]
      \item Montrer que, pour tout $x>0$,
            $f'(x) = \dfrac{x-1}{x^{2}}$. \bareme{1,5 ; 1,25}
