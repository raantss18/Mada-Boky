...
\end{tabular}
\end{center}
Remarquer~: la formule~(4) $\lnot(P\land Q)$ est identique \`a~(8) $\lnot P\lor\lnot Q$~:
...
\begin{enumerate}
  ...
  \item $\lnot(\exists x\in\R,\ x^2<0)$, autrement dit $\forall x\in\R,\ x^2\geq0$.
...
\begin{enumerate}
  ...
  \item $n\geq0$ pour $n\in\N$~: \textbf{condition n\'ecessaire.}
        Tout $n\in\N$ satisfait $n\geq0$, mais $n=0{,}5\geq0$ et $0{,}5\notin\N$.
  \item $\Delta>0$ pour deux racines r\'eelles distinctes~:
        \textbf{condition n\'ecessaire et suffisante (CNS).}
        $ax^2+bx+c$ a deux racines r\'eelles distinctes $\Leftrightarrow\Delta>0$.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item \textbf{D\'emonstration.} Consid\'erons un triangle $A'B'C'$ rectangle en $C'$
        avec $A'C'=AC$ et $B'C'=BC$. Alors $A'B'^2=AC^2+BC^2=AB^2$,
        donc $A'B'=AB$. Par~SSS, le triangle $ABC$ est isom\'etrique \`a $A'B'C'$~:
        il est donc rectangle en $C$.\hfill$\square$
\end{enumerate}
