...
\input{activities/03-calcul-reels}
%% ════════════════════════════════════════════════════════════════
...
\begin{enumerate}
  ...
  \item Application~: montrer que $(1{,}05)^{10} \geq 1{,}5$.
        \emph{(Utiliser $(1+x)^n \geq 1+nx$, admis pour tout
        $n \geq 1$ entier et $x \geq -1$.)}
\end{enumerate}
\end{exo}
...
circonscrivant un polygone r\'egulier \`a $96$ c\^ot\'es dans et autour
...
\begin{enumerate}
  ...
  \item $\exists x\in[0,+\infty[,\ \sqrt{x}<0$.
...
\begin{enumerate}
  ...
  \item \og $\Delta>0$\fg\ pour que \og $ax^2+bx+c=0$,
        avec $a\ne0$, ait deux racines r\'eelles distinctes\fg.
\end{enumerate}
\end{exo}
