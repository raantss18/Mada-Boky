...
\end{enumerate}
\end{multicols}
Comparer les lignes (4) et (6), puis (3) et (5).
Que remarque-t-on~? (Lois de De Morgan\index{lois de De Morgan}.)
\end{exo}
...
\begin{enumerate}
  ...
  \item Pour tout $a, b \in \Z$ : si $a$ et $b$ sont impairs,
        alors $a + b$ est pair.
  \item Pour tout $a, b \in \Z$ : si $a \mid b$ et $b \mid c$, alors $a \mid c$.
\end{enumerate}
\end{exo}
